function ThermometerGuage(canvas, options) {
    ...
    function setOptions(options) {
        ...
        //jQuery.extend(true, that.settings, options);  //the easy way, but depends on jQuery, so here's the hard way ;-(  ...
            ...
            _.color.fillDgreen      =  options.color.fillDgreen      || _.color.fillDgreen       ||  '#43d89a';
            _.color.fillLgreen      =  options.color.fillLgreen      || _.color.fillLgreen		 ||  '#5f0';
            _.color.fillYellow      =  options.color.fillYellow      || _.color.fillYellow 	     ||  '#ff0';
            _.color.fillOrange      =  options.color.fillOrange      || _.color.fillOrange		 ||  '#f50';
            _.color.fillRed         =  options.color.fillRed         || _.color.fillRed 		 ||  '#f00';
            _.color.label           =  options.color.label           || _.color.label            ||  'rgba(45, 45, 45, 1)';
            _.color.outline         =  options.color.outline         || _.color.outline          ||  'rgb(255, 255, 255)';
            _.color.outlineFill     =  options.color.outlineFill     || _.color.outlineFill      ||  'rgb(119, 25, 50)';
            ...
            _.bulbRadiusProportion  =  options.bulbRadiusProportion  || _.bulbRadiusProportion   ||  0.15;
	...
	//Katie's if statement for changing colour on the fill depending on value
		
	if (fillTo < 3.0) {
     	ctx.strokeStyle = _.color.fillDgreen;
     	ctx.fillStyle = _.color.fillDgreen; 		
     } else if ((fillTo > 3.0) && (fillTo < 10.0)) {
      	ctx.strokeStyle = _.color.fillLgreen;
      	ctx.fillStyle = _.color.fillLgreen; 
     } else if ((fillTo > 10.0) && (fillTo < 20.0)) {
    	ctx.strokeStyle = _.color.fillYellow;
     	ctx.fillStyle = _.color.fillYellow; 
     }	else if ((fillTo > 20.0) && (fillTo < 30.0)) {
    	ctx.strokeStyle = _.color.fillOrange;
      	ctx.fillStyle = _.color.fillOrange;   
     }  else if ((fillTo > 30.0)) {
      	ctx.strokeStyle = _.color.fillRed;
      	ctx.fillStyle = _.color.fillRed;  
     }
